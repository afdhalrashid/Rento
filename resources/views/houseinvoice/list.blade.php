            ...
            <div class="page-title">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 order-md-2 order-first">
                        ...
                        {{-- <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#logoinvois">
                            Logo invois</button> --}}
                        <button type="button" class="btn btn-secondary" onclick="editLogo({{ $house->id }} );">
                            Logo Invois</button>
                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @php
                                            $i = 0;
                                        @endphp
                                        @foreach ($house->invoice as $invoice)
                                            <tr>
                                                <td class="">{{ ++$i }}</td>
                                                <td class="">{{ $invoice->invoice_name }}</td>
                                                            <td class="

                                                    ">
                                                    {{ $invoice->invoice_number }}</td>
                                                <td class="">
                                                    @if ($invoice->invoice_save_path != '')
                                                        {{-- {{ $cost->image_name }} --}}
                                                        {{-- <a class="
                                                    btn-sm btn-success"
                                                    href="{{ route('downloadinvoice', $invoice->id) }}">Download</a>
                                                    <a class="btn-sm btn-info"
                                                        href="{{ route('viewinvoice', $invoice->id) }}"
                                                        target="_blank">Open</a> --}}

                                                        <a class="btn-sm btn-success" data-toggle="tooltip"
                                                        data-placement="top" title="Muat turun"
                                                            href="{{ route('downloadinvoice', $invoice->id) }}"><i
                                                            class="far fa-arrow-alt-circle-down"></i></a>
                                                        <a class="btn-sm btn-info" data-toggle="tooltip"
                                                        data-placement="top" title="Buka" href="{{ route('viewinvoice', $invoice->id) }}"
                                        ...
                                        <td>
                                            @if ($invoice->receipt != '')
                                                ...
                                                {{-- <a class="btn-sm btn-success"
                                                    href="{{ route('downloadreceipt', $invoice->id) }}">Download</a>
                                                <a class="btn-sm btn-info"
                                                    href="{{ route('viewreceipt', $invoice->id) }}"
                                                    target="_blank">Open</a> --}}
                                                    <a class="btn-sm btn-success" data-toggle="tooltip"
                                                        data-placement="top" title="Muat turun"
                                                            href="{{ route('downloadreceipt',   $invoice->id) }}"><i
                                                            class="far fa-arrow-alt-circle-down"></i></a>
                                                        <a class="btn-sm btn-info" data-toggle="tooltip"
                                                        data-placement="top" title="Buka" href="{{ route('viewreceipt', $invoice->id) }}"
                                                            target="_blank"><i class="fas fa-external-link-alt"></i></a>
                                                <button type="button" class="btn-sm btn-light mx-1" data-toggle="tooltip"
                                                data-placement="top" title="Lampiran"
                                                    onclick="loadImageModal('{{ $invoice->id }}','{{ $invoice->payment_attachments->image_path }}')"><i
                                        ...
                                        <td>
                                            @if ($invoice->receipt == '')
                                                <button type="button" class="btn-sm btn-info mx-1"
                                                    onclick="loadReceiptModal('{{ $invoice->id }}','{{ $invoice->invoice_number }}')">Resit
                                                </button>
                                            @endif
                                            <button type="button" class="btn btn-danger btn-sm"
                                                onclick="loadDeleteModal('{{ $house->id }}','{{ $invoice->id }}','{{ $invoice->invoice_number }}')"><i class="far fa-trash-alt"></i>
                                            </button>
                                        </td>
                                        </tr>
                                        @endforeach
                                ...
                                <div class="col-sm-7 col-md-7 col-lg-7 px-0">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control shadow-sm" maxlength="100" id="invois_name"
                                            name="invois_name" value="{{ old('invois_name') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-select-sm shadow-sm"
                                            ...
                                            @foreach ($users_createdby_owner as $user)
                                                ...
                                                @if (Request::old('tenant_user_id') == $user->type_id)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-select-sm shadow-sm"
                                            ...
                                            @foreach ($house->bank_accounts as $item)
                                                ...
                                                @if (Request::old('akaun_bank') == $item->type_id)
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-1 col-md-1 col-lg-1 px-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control shadow-sm alphaonly" maxlength="100"
                                            id="invois_unit" name="invois_unit[]" value="{{ old('invois_unit.0') }}">
                                    </div>
                                </div>
                                ...
                                <input id="house_id" name="house_id" type="hidden" value="{{ $house->id }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row custom-file">
                                        <input type="file" class="custom-file-input chooseFile"
                                            ...
                                            value="{{ old('tenant_payment_attachment') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row custom-file">
                                        <input type="file" class="custom-file-input chooseFile" id="logo_invois"
                                            name="logo_invois" value="{{ old('logo_invois') }}">
