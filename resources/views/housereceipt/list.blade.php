            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h4>Resit</h4>
                        <p class="text-subtitle text-muted">Hasilkan resit sewa </p>
                    </div>
            ...
            <section class="section">
                <div class="row">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-9">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Resit sewaan rumah</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-10 col-md-10 col-lg-10">
                                        <div class="form-group">
                                            <label for="helpInputTop">Tajuk resit</label>
                                            <small class="text-muted">cth.<i> Resit sewa bulan April 2021</i></small>
                                            <input type="text" class="form-control shadow-sm" id="helpInputTop" name="receipt_name" value="Invois Sewa Bulan April 2021">
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-1 mb-1">
                        ...
                        <div class="row offset-md-5 offset-lg-5">
                            <button id="button_generate_receipt" type="submit" class="btn btn-primary btn-sm">Hasilkan resit</button>
                        </div>
                    </div>
...
@section('js')
<script>
    $('#button_generate_receipt').click(function (e) {
        e.preventDefault();
        $.ajax({
        type: "get",
